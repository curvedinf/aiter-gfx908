...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=988
    FILE_TIMES[op_tests/test_mla.py]=844
    FILE_TIMES[op_tests/test_mla_persistent.py]=792
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=765
    FILE_TIMES[op_tests/test_mha.py]=690
    FILE_TIMES[op_tests/test_pa.py]=647
    FILE_TIMES[op_tests/test_batch_prefill.py]=642
    FILE_TIMES[op_tests/test_mla_sparse.py]=570
    ...
    FILE_TIMES[op_tests/test_moe_topk_gating.py]=196
    FILE_TIMES[op_tests/test_moe_sorting.py]=143
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=116
    FILE_TIMES[op_tests/test_pa_mtp.py]=107
    FILE_TIMES[op_tests/test_moe_2stage.py]=100
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale_cktile_aq_rowmajor.py]=88
    ...
    FILE_TIMES[op_tests/test_aiter_addInp.py]=37
    ...
    FILE_TIMES[op_tests/test_mhc.py]=28
    ...
    FILE_TIMES[op_tests/test_flydsl_compress_attn.py]=22
    FILE_TIMES[op_tests/test_rmsnorm2d.py]=22
    FILE_TIMES[op_tests/test_sampling.py]=21
    FILE_TIMES[op_tests/test_mla_prefill_ps.py]=20
    FILE_TIMES[op_tests/test_moe_blockscale.py]=20
    FILE_TIMES[op_tests/test_pa_sparse_prefill_opus.py]=20
    ...
    FILE_TIMES[op_tests/test_quant_mxfp4.py]=6
    ...
    FILE_TIMES[op_tests/test_opus_a16w16_gemm.py]=4
    ...
    FILE_TIMES[op_tests/triton_tests/test_causal_conv1d.py]=710
    ...
    FILE_TIMES[op_tests/triton_tests/test_gated_delta_rule.py]=274
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_a16w16.py]=248
    FILE_TIMES[op_tests/triton_tests/rope/test_fused_qkv_split_qk_rope.py]=219
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_pe.py]=208
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w4.py]=201
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=159
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=157
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=157
    FILE_TIMES[op_tests/triton_tests/moe/test_moe.py]=149
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=142
    FILE_TIMES[op_tests/triton_tests/fusions/test_mhc.py]=117
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8.py]=115
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_afp4wfp4.py]=103
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_mul_add.py]=102
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16_gated.py]=100
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8_blockscale.py]=99
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_mxfp4_quant.py]=96
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16_fused.py]=95
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16.py]=88
    FILE_TIMES[op_tests/triton_tests/attention/test_mla.py]=85
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=80
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_a16w16.py]=78
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a16w4.py]=72
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing.py]=70
    FILE_TIMES[op_tests/triton_tests/normalization/test_layernorm.py]=69
    FILE_TIMES[op_tests/triton_tests/normalization/test_rmsnorm.py]=65
    FILE_TIMES[op_tests/triton_tests/attention/test_flash_attn_kvcache.py]=61
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_bmm_rope_kv_cache.py]=61
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=53
    FILE_TIMES[op_tests/triton_tests/test_gmm.py]=52
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode_sparse.py]=50
    FILE_TIMES[op_tests/triton_tests/test_activation.py]=49
    FILE_TIMES[op_tests/triton_tests/attention/test_la.py]=48
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_int8_smoothquant.py]=47
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_split_cat.py]=35
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16.py]=33
    FILE_TIMES[op_tests/triton_tests/attention/test_mla_decode_rope.py]=31
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_afp4wfp4.py]=27
    FILE_TIMES[op_tests/triton_tests/attention/test_chunked_pa_prefill.py]=23
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_dao_ai.py]=20
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w8_blockscale.py]=19
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_bf16.py]=13
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_extend_attention.py]=5
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_routing_from_topk.py]=4
