...
def _build_gemm1_stage(stage_idx: int,
                       exp_per_msb: int,
                       cheap_per_msb: int,
                       lds_type: str = 'K',
                       has_tdm: bool = False) -> List[List[int]]:
...
def _build_gemm2_stage(stage_idx: int,
                       p0_per_msb: int,
                       p1_total: int,
                       p2_per_msb: int,
...
# ---------------------------------------------------------------------------
_TOKEN_NAMES = {
    0:'P0m0', 1:'P0m1', 2:'P0m2', 3:'P0m3',
    4:'P1',
    5:'P2m0', 6:'P2m1', 7:'P2m2', 8:'P2m3',      # pkfma/setup (1cy)
    9:'K_m0', 10:'K_m1', 11:'K_m2', 12:'K_m3',
    13:'V_m0', 14:'V_m1', 15:'V_m2', 16:'V_m3',
    17:'ORS0', 18:'TDM',
    19:'EXPm0', 20:'EXPm1', 21:'EXPm2', 22:'EXPm3',  # pair_exp (3cy!)
}
