    ...
    if True:
        ...
        def moe_gemm2(
            ...
            def _moe_gemm2_then_body():
                ...
                # stage2 no longer specializes K-tail on inter_dim_pad: weight
                # pad region is zero so always running the full k_unroll is
                # correct and equally fast (same argument as stage1).
                _pad_k_elems_s2 = 0
                _pad_ku_skip_s2 = 0
                _tail_ku_s2 = k_unroll
                _tail_ku_packed_s2 = None
