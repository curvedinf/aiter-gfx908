...
def kernel_unified_attention_2d(
    ...
    q_scale,  # None or float32 scalar (per tensor fp8)
    k_scale,  # None or float32 scalar (per tensor fp8)
    v_scale,  # None or float32 scalar (per tensor fp8)
    out_scale,  # float32
    softcap,  # float32
