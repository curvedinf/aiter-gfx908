...
def conv3d_channel_last(
    ...
    _LOGGER.info(f"CONV3D_CHANNEL_LAST kernel execution time: {gt.elapsed} ms")
    _LOGGER.info(f"CONV3D_CHANNEL_LAST achieved bandwidth: {gt.bandwidth:.2f} GB/s")
    _LOGGER.info(f"CONV3D_CHANNEL_LAST achieved FLOPS: {gt.computation:.2f} TFLOPS")
