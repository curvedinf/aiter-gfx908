...
from aiter.ops.triton._triton_kernels.conv.conv3d.conv3d_std import _conv3d_std_kernel
...
def conv3d_std(
    ...
    """
    _LOGGER.info(
        f"CONV3D_STD called with x shape: {x.shape}, weight shape: {weight.shape}"
    )
