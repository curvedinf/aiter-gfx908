...
def fused_qk_rope_cat_and_cache_mla(
    ...
    _qk_rope_cat_and_cache_mla_kernel[grid](
        ...
        *k_pe.stride(),
        ...
        cos.stride(-1),
        *q_out.stride(),
        q_nope_zeros_out.stride(0) if q_nope_zeros_out else 0,
        q_nope_zeros_out.stride(1) if q_nope_zeros_out else 0,
        q_nope_zeros_out.stride(2) if q_nope_zeros_out else 0,
        *kv_cache.stride(),
        k_scale_ptr=k_scale,
        QH_PER_KH=qh // kh,
        QH=qh,
