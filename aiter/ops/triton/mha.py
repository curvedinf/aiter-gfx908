...
def _preprocess_tile(
    ...
    return continue_condition, cu_seqlens_q_start, cu_seqlens_k_start, seqlen_q, seqlen_k, offs_m, offs_n, offs_d
...
def _process_tile(
    ...
    return alibi_slope, q, descale_q, descale_k, descale_v
