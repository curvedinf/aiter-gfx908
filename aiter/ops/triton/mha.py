...
def _check_validity(
    ...
    return continue_condition, seqlen_q, seqlen_k, cu_seqlens_q_start, cu_seqlens_k_start, n_blocks
...
def _process_query(
    ...
    offs_n,
    offs_d,
    seqlen_q, seqlen_k, cu_seqlens_q_start, cu_seqlens_k_start, n_blocks,
    start_m: tl.constexpr,
    off_z: tl.constexpr,
    off_q_head: tl.constexpr,
    k_ptr: torch.Tensor,
