...
def _compile_deepgemm_fp8_paged_mqa_logits(
    ...
    if schedule_metadata is not None:
        fn_signature["mqa_schedule_metadata"] = "*i32"
...
def deepgemm_fp8_paged_mqa_logits(
    ...
    kernel = _compile_deepgemm_fp8_paged_mqa_logits(
        ...
        WavePerEU=WavePerEU,
        schedule_metadata=mqa_schedule_metadata,
    )

    if mqa_schedule_metadata is None:
