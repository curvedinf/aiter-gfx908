...
def unified_attention(
    ...
    q = q.to(torch.float8_e4m3fn).to(q.dtype)
    convert_kv_cache(q, k, v, seqused_k, max_seqlen_k, block_table, group_size=16, ignore_scales=False, sliding_window=SLIDING_WINDOW)
