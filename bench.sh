...
export PYTHONPATH=/app/aiter/aiter/ops/flydsl:${PYTHONPATH}
export AITER_GFX1250_TDM_GATHER=1
python -m kernels.bench_moe_lds_bw --experts 256 --model_dim 7168 --inter_dim 2048 --tile_n 128 --tile_k 256 --num_stages 4 --dtype fp8
