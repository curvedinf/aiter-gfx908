...
#   id: kernel:             BLOCK_SIZE| MPerBLOCK| NPerBLOCK| KPerBLOCK| MWaves| NWaves|GemmPipelineVersion
     ...
     5: kernelInstanceGEMM1(       256,       128,        64,        64,     1,       4,        1,),
     6: kernelInstanceGEMM1(       256,        32,       128,       128,     1,       4,        1,),
     7: kernelInstanceGEMM1(       256,        32,       128,        64,     1,       4,        1,),
     8: kernelInstanceGEMM1(       256,        64,       128,       128,     1,       4,        1,),
     9: kernelInstanceGEMM1(       256,        64,       128,        64,     1,       4,        1,),
     10: kernelInstanceGEMM1(      256,       128,       128,       128,     1,       4,        1,),
     11: kernelInstanceGEMM1(      256,       128,       128,        64,     1,       4,        1,),

     12: kernelInstanceGEMM1(      256,        64,        64,       128,     1,       4,        3,),
     13: kernelInstanceGEMM1(      256,        64,        64,        64,     1,       4,        3,),
     14: kernelInstanceGEMM1(      256,        64,       128,       128,     1,       4,        3,),
     15: kernelInstanceGEMM1(      256,        64,       128,        64,     1,       4,        3,),
     16: kernelInstanceGEMM1(      256,       128,        64,       128,     1,       4,        3,),
     17: kernelInstanceGEMM1(      256,       128,        64,        64,     1,       4,        3,),
     18: kernelInstanceGEMM1(      256,       128,       128,       128,     1,       4,        3,),
     19: kernelInstanceGEMM1(      256,       128,       128,        64,     1,       4,        3,),
...
a8w8_gemm1_kernels_list_gfx950= {
     0: kernelInstanceGEMM1(       256,        32,        64,       128,     1,       4,        1,),
     1: kernelInstanceGEMM1(       256,        32,        64,       256,     1,       4,        1,),
     2: kernelInstanceGEMM1(       256,        64,        64,       128,     1,       4,        1,),
     3: kernelInstanceGEMM1(       256,        64,        64,       256,     1,       4,        1,),
     4: kernelInstanceGEMM1(       256,       128,        64,       128,     1,       4,        1,),
     5: kernelInstanceGEMM1(       256,       128,        64,       256,     1,       4,        1,),
     6: kernelInstanceGEMM1(       256,        32,       128,       128,     1,       4,        1,),
     7: kernelInstanceGEMM1(       256,        32,       128,       256,     1,       4,        1,),
     8: kernelInstanceGEMM1(       256,        64,       128,       128,     1,       4,        1,),
     9: kernelInstanceGEMM1(       256,        64,       128,       256,     1,       4,        1,),
     10: kernelInstanceGEMM1(      256,       128,       128,       128,     1,       4,        1,),
     11: kernelInstanceGEMM1(      256,       128,       128,       256,     1,       4,        1,),

    #  12: kernelInstanceGEMM1(      256,        64,        64,       128,     1,       4,        3,),
    #  13: kernelInstanceGEMM1(      256,        64,        64,       256,     1,       4,        3,),
    #  14: kernelInstanceGEMM1(      256,        64,       128,       128,     1,       4,        3,),
    #  15: kernelInstanceGEMM1(      256,        64,       128,       256,     1,       4,        3,),
     16: kernelInstanceGEMM1(      256,       128,        64,       128,     1,       4,        3,),
     17: kernelInstanceGEMM1(      256,       128,        64,       256,     1,       4,        3,),
     18: kernelInstanceGEMM1(      256,       128,       128,       128,     1,       4,        3,),
     19: kernelInstanceGEMM1(      256,       128,       128,       256,     1,       4,        3,),
     20: kernelInstanceGEMM1(      256,       128,       128,       128,     1,       4,        3,),
...
a4w4_gemm1_kernels_list= {
     ...
     2: kernelInstanceGEMM1(       256,      128,         128,       128,     1,       4,        3,),
     3: kernelInstanceGEMM1(       256,       16,         128,       128,     1,       4,        3,),
}
...
# gemm2 out&AB:bf16/fp16
     ...
     1: kernelInstanceGEMM2(       256,        32,        64,        64,     1,       4,        1,),
     2: kernelInstanceGEMM2(       256,        64,        64,       128,     1,       4,        1,),
     3: kernelInstanceGEMM2(       256,        64,        64,        64,     1,       4,        1,),
     4: kernelInstanceGEMM2(       256,       128,        64,       128,     1,       4,        1,),
     5: kernelInstanceGEMM2(       256,       128,        64,        64,     1,       4,        1,),
     6: kernelInstanceGEMM2(       256,        32,       128,       128,     1,       4,        1,),
     7: kernelInstanceGEMM2(       256,        32,       128,        64,     1,       4,        1,),
     8: kernelInstanceGEMM2(       256,        64,       128,       128,     1,       4,        1,),
     9: kernelInstanceGEMM2(       256,        64,       128,        64,     1,       4,        1,),
     10: kernelInstanceGEMM2(      256,       128,       128,       128,     1,       4,        1,),
     11: kernelInstanceGEMM2(      256,       128,       128,        64,     1,       4,        1,),

     12: kernelInstanceGEMM2(      256,        64,        64,       128,     1,       4,        3,),
     13: kernelInstanceGEMM2(      256,        64,        64,        64,     1,       4,        3,),
     14: kernelInstanceGEMM2(      256,        64,       128,       128,     1,       4,        3,),
     15: kernelInstanceGEMM2(      256,        64,       128,        64,     1,       4,        3,),
     16: kernelInstanceGEMM2(      256,       128,        64,       128,     1,       4,        3,),
     17: kernelInstanceGEMM2(      256,       128,        64,        64,     1,       4,        3,),
     18: kernelInstanceGEMM2(      256,       128,       128,       128,     1,       4,        3,),
     19: kernelInstanceGEMM2(      256,       128,       128,        64,     1,       4,        3,),
     ...
     27: kernelInstanceGEMM2(       64,        32,         32,       64,     1,       1,        1,),
     28: kernelInstanceGEMM2(       64,        64,        128,       64,     1,       1,        3,),
     29: kernelInstanceGEMM2(       64,       128,        128,       64,     1,       1,        3,),
     30: kernelInstanceGEMM2(       64,        16,         16,       64,     1,       1,        1,),
}
...
a8w8_gemm2_kernels_list_gfx950= {
     0: kernelInstanceGEMM2(       256,        32,        64,       128,     1,       4,        1,),
     1: kernelInstanceGEMM2(       256,        32,        64,       256,     1,       4,        1,),
     2: kernelInstanceGEMM2(       256,        64,        64,       128,     1,       4,        1,),
     3: kernelInstanceGEMM2(       256,        64,        64,       256,     1,       4,        1,),
     4: kernelInstanceGEMM2(       256,       128,        64,       128,     1,       4,        1,),
     5: kernelInstanceGEMM2(       256,       128,        64,       256,     1,       4,        1,),
     6: kernelInstanceGEMM2(       256,        32,       128,       128,     1,       4,        1,),
     7: kernelInstanceGEMM2(       256,        32,       128,       256,     1,       4,        1,),
     8: kernelInstanceGEMM2(       256,        64,       128,       128,     1,       4,        1,),
     9: kernelInstanceGEMM2(       256,        64,       128,       256,     1,       4,        1,),
     10: kernelInstanceGEMM2(      256,       128,       128,       128,     1,       4,        1,),
     11: kernelInstanceGEMM2(      256,       128,       128,       256,     1,       4,        1,),

    #  12: kernelInstanceGEMM2(      256,        64,        64,       128,     1,       4,        3,),
    #  13: kernelInstanceGEMM2(      256,        64,        64,       256,     1,       4,        3,),
    #  14: kernelInstanceGEMM2(      256,        64,       128,       128,     1,       4,        3,),
    #  15: kernelInstanceGEMM2(      256,        64,       128,       256,     1,       4,        3,),
     16: kernelInstanceGEMM2(      256,       128,        64,       128,     1,       4,        3,),
     17: kernelInstanceGEMM2(      256,       128,        64,       256,     1,       4,        3,),
     18: kernelInstanceGEMM2(      256,       128,       128,       128,     1,       4,        3,),
     19: kernelInstanceGEMM2(      256,       128,       128,       256,     1,       4,        3,),
     20: kernelInstanceGEMM2(      256,       128,       128,       128,     1,       4,        3,),
...
a4w4_gemm2_kernels_list= {
     ...
     5: kernelInstanceGEMM2(        64,        64,         64,       128,     1,       1,         1,),
     6: kernelInstanceGEMM2(        64,       128,        128,       128,     1,       1,         1,),
    #  4: kernelInstanceGEMM2(        64,        16,         32,       256,     1,       1,         1,),
