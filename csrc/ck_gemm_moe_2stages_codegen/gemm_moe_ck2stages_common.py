...
#   id: kernel:             BLOCK_SIZE| MPerBLOCK| NPerBLOCK| KPerBLOCK| MWaves| NWaves|GemmPipelineVersion
    ...
    11: kernelInstanceGEMM1(        64,        32,        32,        64,     1,       1,        1,),
    12: kernelInstanceGEMM1(        64,        64,        32,        64,     1,       1,        1,),
    13: kernelInstanceGEMM1(        64,       128,        32,        64,     1,       1,        1,),
    14: kernelInstanceGEMM1(        64,       256,        32,        64,     1,       1,        1,),
}
...
a8w8_gemm1_kernels_list= {
    ...
    11: kernelInstanceGEMM1(       256,        16,        64,       256,     1,       4,        1,),
}
