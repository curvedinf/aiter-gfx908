...
#define CUSTOM_ALL_REDUCE_PYBIND                                                     \
    ...
    m.def("fused_allreduce_rmsnorm_quant_int8_per_group",                            \
          &aiter::fused_allreduce_rmsnorm_quant_int8_per_group,                      \
          py::arg("_fa"),                                                            \
          py::arg("inp"),                                                            \
          py::arg("res_inp"),                                                        \
          py::arg("res_out"),                                                        \
          ...
          py::arg("gemma_norm")   = false,                                           \
          py::arg("bf16_out_ptr") = static_cast<int64_t>(0));                        \
    m.def("fused_allreduce_rmsnorm_quant_int8_per_token",                            \
          &aiter::fused_allreduce_rmsnorm_quant_int8_per_token,                      \
          py::arg("_fa"),                                                            \
          py::arg("inp"),                                                            \
          py::arg("res_inp"),                                                        \
          py::arg("res_out"),                                                        \
