...
>>>>>>> 94934e7d (update codegen.py (#880))
// #######################################################|HDim|    DataType| MaskType|kIsAtomic32|BF16Cvt|kIsSEQPad|kIsHDPad|         GPUArch|kIsGroupMode|
...
<<<<<<< HEAD:csrc/py_itfs_cu/fmha_v3_bwd_kernel_generate.py
...
>>>>>>> b907a561 (Enable FA multi target build (#774)):hsa/gfx950/fmha_v3_bwd/codegen.py
    );
}}
=======
