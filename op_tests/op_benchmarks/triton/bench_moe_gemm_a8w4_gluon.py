...
from aiter.ops.triton.moe_op_gemm_a8w4_gluon import moe_gemm_a8w4_gluon
...
def bench_mlp(batch, dim1, dim2, n_expts_tot, n_expts_act, x_dtype, w_dtype, TP, op_regex):
    ...
    for i in range(reps):
        ...
        if x_dtype_str == "fp8":
            ...
            x = moe_gemm_a8w4_gluon(x, w1, None, w1_scale, static_scale, static_scale, b1, rdata, gather_indx=gather_indx, swizzle_mx_scale=swizzle_mx_scale1, out_dtype=x_dtype, apply_swiglu=True)
...
if __name__ == "__main__":
    ...
    batch_ranges_moe = [(1, 2, 1), (2, 5, 2), (8, 18, 8), (32, 65, 32), (128, 257, 128)]
