...
def test_top_k_per_row_prefill(
    ...
    print(f"Standard Kernel performance test completed: {us_standard:.2f} ms")
    ...
    print(f"Fast Kernel performance test completed: {us_fast:.2f} ms")
    ...
    print(
        f"  Standard version: {standard_color}{us_standard:.2f} ms{RESET}, correct={all_close_standard}"
    )
    print(
        f"  Fast version:     {fast_color}{us_fast:.2f} ms{RESET}, correct={all_close_fast}"
    )
