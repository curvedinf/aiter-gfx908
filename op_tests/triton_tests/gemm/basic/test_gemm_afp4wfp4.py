...
def get_x_vals():
    ...
    x_vals += [
        (v, 2304, 16384)
        for v in (15, 16, 31, 32, 63, 64, 127, 128, 255, 256, 8191, 8192)
    ]
    x_vals += [
        (v, 2560, 8192)
        for v in (7, 8, 30, 31, 32, 63, 64, 127, 128, 255, 256, 8191, 8192)
    ]
    x_vals += [
        (v, 3072, 1536)
        for v in (
    ...
    x_vals += [
        (v, 7168, 256) for v in (15, 16, 31, 32, 63, 64, 127, 128, 255, 256, 8191, 8192)
    ]
    x_vals += [
        (v, 7168, 2048)
        for v in (
    ...
    x_vals += [
        (v, 7168, 8192)
        for v in (7, 8, 30, 31, 32, 63, 64, 127, 128, 255, 256, 511, 512, 8191, 8192)
    ]
    x_vals += [
        (v, 7168, 16384)
        for v in (
    ...
    x_vals += [
        (v, 9216, 16384)
        for v in (7, 8, 15, 16, 31, 32, 63, 64, 127, 128, 255, 256, 8191, 8192)
    ]
    x_vals += [
        (v, 10240, 8192)
        for v in (7, 8, 30, 31, 32, 63, 64, 127, 128, 255, 256, 8191, 8192)
    ...
    x_vals += [
        (v, 18432, 16384)
        for v in (7, 8, 15, 16, 30, 31, 32, 63, 64, 127, 128, 255, 256, 8191, 8192)
    ]
    x_vals += [
        (v, 24576, 1536)
        for v in (
