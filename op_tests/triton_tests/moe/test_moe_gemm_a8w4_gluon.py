...
@pytest.mark.parametrize(
    ...
    [
        ...
        for case in [
            ...
            #Case(512, 512, 512, "float8_e4m3fn", 32, 2),
            #Case(1024, 512, 512, "float8_e4m3fn", 128, 4),
            #Case(16, 1024, 1024, "float8_e4m3fn", 128, 4), #, hbm_swizzling=True),
            #Case(4096, 1024, 1024, "float8_e4m3fn", 128, 4),
            #Case(16, 256, 256, "float8_e4m3fn", 128, 4) #, hbm_swizzling=True),
...
def test_op(
    ...
    if apply_swiglu and has_y_gammas:
        pytest.skip("swiglu and gammas are not supported together")
