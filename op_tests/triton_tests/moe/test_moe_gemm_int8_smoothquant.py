...
@pytest.mark.parametrize(
    ...
    [
        ...
        for case in [
            ...
            # Doubao MOE (128 experts, topk=6 routed + 2 shared)
            Case(16, 2560, 4096, 128, 8),
            Case(128, 2560, 4096, 128, 8),
            Case(512, 2560, 4096, 128, 8),
            Case(2048, 2560, 4096, 128, 8),
            # Down projection
            Case(16, 4096, 1280, 128, 8),
            Case(128, 4096, 1280, 128, 8),
            Case(512, 4096, 1280, 128, 8),
            Case(2048, 4096, 1280, 128, 8),
        ]
    ],
)
@pytest.mark.parametrize(
