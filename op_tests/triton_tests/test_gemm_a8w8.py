...
def test_gemm(in_dtype, out_dtype, m, n, k, layout, output, impl: str):
    ...
    if impl in ["triton_shuffle", "gluon_shuffle"] and (n % 16 != 0 or k % 16 != 0):
        pytest.skip("Shuffled implementation requires N to be multiple of 16.")
    ...
    if impl == "gluon":
        ...
        impl = triton_gemm_a8w8_preshuffle
