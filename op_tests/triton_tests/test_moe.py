...
from  aiter.ops.triton.utils.arch_info import get_device 
...
def test_moe_e2e(
    ...
    print(triton_intermediate.flatten()[0:100])
    print(torch_intermediate.flatten()[0:100])
    torch.testing.assert_close(
...
if __name__ == "__main__":
    test_moe_e2e(33, 1536, 4096, 8, 128, False, True, 128, 128, torch.bfloat16, 8)
    print("test passed")