...
You may also look for files related to GPU optimisation for kernels of a similar style.
...
Then explore the documentation in the directory  /aimodels/performance_guide/docs for performance optimisation hints and apply this to the kernels listed later.
