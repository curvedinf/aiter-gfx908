...
# python /workspace/aiter_dev/op_tests/test_moe_lqq.py -t 256 512 1024 1664 -e 128 -k 6 -md 5120 -id 1536 -ep 8 -se 2 -x 64 # --evenly
...
python /workspace/aiter_dev/op_tests/test_moe_lqq.py -t 256 512 1024 1536 1664 2048 4096 -e 384 -k 8 -md 3584 -id 1024 -ep 8 -se 0 -x 32 64 80 --evenly
