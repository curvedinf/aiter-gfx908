...
AITER_FLYDSL_GEMM2_MODE=ATOMIC  python op_tests/test_moe_lqq.py -t 1024 -e 384 -k 8 -md 3584 -id 1024 -ep 8 -se 0 -x 32 --evenly
# python op_tests/test_moe_lqq.py -t 1024 -e 384 -k 8 -md 3584 -id 1024 -ep 8 -se 0 -x 32 --evenly
